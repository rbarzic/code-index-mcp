...
from .c_strategy import CParsingStrategy
...
class StrategyFactory:
    ...
    def _initialize_strategies(self):
        ...
        with self._lock:
            ...
            try:
                ...
                # C
                c_strategy = CParsingStrategy()
                for ext in c_strategy.get_supported_extensions():
                    self._strategies[ext] = c_strategy
    ...
    def get_strategy_info(self) -> Dict[str, List[str]]:
        ...
        for lang in fallback_languages:
            extensions = [
                ext
                for ext, mapped_lang in self._file_type_mappings.items()
                if mapped_lang == lang
            ]
